...
class TestOrderServiceConsume(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        self.events = _load_events_module("order-service")
    ...
    async def test_consume_handler_success_commits_and_records_success(self):
        ...
        await self.events.consume(["order.placed"], "og", handler)
