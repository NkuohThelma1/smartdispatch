...
class TestDeliveryServiceConsume(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        self.events = _load_events_module("delivery-service")
    ...
    async def test_consume_handler_success_commits_and_records_success(self):
        msgs = [FakeMsg("delivery.assigned", 0, 1, "k1", {"_stream": "delivery.assigned", "order_id": "o1"})]
        ...
        await self.events.consume(["delivery.assigned"], "dg", handler)
